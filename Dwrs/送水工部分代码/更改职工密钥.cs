...
namespace 宿舍饮用水登记系统
{
    public partial class 更改职工密钥 : Form
    {
        ...
        public int ChangeKeyWorkers(NetworkStream ns, string changeKeyWorkers)
        {
            //0表示验证---用户---用户名和密码是否正确
            ...
            //26表示---送水职工---查询职工密钥
            //27表示---送水职工---更改职工密钥
            AsciiGetBytesSend(ns, "27");
            AsciiGetBytesSend(ns, changeKeyWorkers);
        ...
        public 更改职工密钥(NetworkStream ns, string account)
        {
            this.ns = ns;
            ...
            keyWorkers = AsciiGetstringRead(ns);
            textBox1.Text = keyWorkers;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输职工密钥！");
            }
            else if (ChangeKeyWorkers(ns, textBox1.Text.Trim()) == 1)
            {
                MessageBox.Show("更改职工密钥成功！");
                this.Close();
            }
            else
                MessageBox.Show("更改职工密钥失败！");
        }
    }
}
